 					<div class="box-content">
						...
						<tr v-show="pending1.length" class="list-group">
							<td style="padding: 2px; vertical-align: top" ><h7 style="font-size: 18px; font-size: 1vw;">1.</h7></td>
							<td style="padding: 2px" v-for="todo1 in pending1" class="list-group-item"><h7 style="font-size: 18px; font-size: 1vw;">{{ todo1.body1 }} <br>
							<button v-on:click="deleteTodo1(todo1)" class="btn btn-default"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
						<button v-on:click="editTodo1(todo1)" class="btn btn-default"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></button></h7></td>
						</tr>
