...
function tambah($conn){
    ...
    if (isset($_POST['btn_simpan'])){
       ...
       $idpejabat=$_POST['idpejabat'];
        ...
        if(!empty($nomorsurat) && !empty($nomoragenda) && !empty($perihal) && !empty($idkecepatan) && !empty($idpejabat) ){
         ...
         <div class="form-group">
                <label for="exampleInputEmail1">Poin Menimbang</label>
                  <div class="form-group addel-target">
                    <div class="input-group">
                        <textarea class="form-control" rows="5" id="inputmenimbang" name="menimbang" ></textarea>
                    </div>
                    <br>
                    <input type="hidden" name="aksi" value="create">

                    <button type="submit" class="btn btn-success addel-add" name="btn_simpan" id="btn" style="margin-top: -10px;  width: 100% !important; display:none;" >
                     ...
                     <div id="list">
                      ...
                      <ul>
                        ...
                        <li id="arrayorder_<?php echo $id ?>"><?php echo $no;?> <?php echo substr($text, 0, 25); ?>
                          <a href="#exampleModal<?php echo $id ?>"  style="color:yellow; " data-toggle="modal" > [ <i class="fa  fa-close"></i>edit ]</a>
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">Poin mengingat</label>
                  <div class="form-group addel-target">
                    <div class="input-group">
                        <textarea  class="form-control" rows="5" id="inputmengingat" name="mengingat" > </textarea>
                    </div>
                     ...
                     <div id="list2">
                      ...
                      <ul>
                        ...
                        <li id="arrayorder2_<?php echo $id ?>"><?php echo $no;?> <?php echo substr($text, 0, 25); ?>
                          <a href="#exampleModal2<?php echo $id ?>"  style="color:yellow;" data-toggle="modal"> [ <i class="fa  fa-close"></i>edit ]</a>
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">Keputusan</label>
                  <div class="form-group addel-target">
                    <div class="input-group">
                        <textarea  class="form-control" rows="5" id="inputmemutuskan" name="keputusan"></textarea>
                    </div>
                     <br><input type="hidden" name="aksi" value="create">
                    <button type="submit" class="btn btn-success addel-add" name="btn_simpan" style="margin-top: -10px;  width: 100% !important;">
                     ...
                     <div id="list3">
                      ...
                      <ul>
                        ...
                        <li id="arrayorder3_<?php echo $id ?>"><?php echo $no;?> <?php echo substr($text, 0, 25); ?>
                          <a href="#exampleModal3<?php echo $id ?>"  style="color:yellow; " data-toggle="modal"> [ <i class="fa  fa-close"></i>edit ]</a>
...
<?php
 $query090909099=mysqli_query($conn, "SELECT id, text FROM dragdrop ORDER BY listorder ASC");
 while($row090909099 = mysqli_fetch_array($query090909099)){
  $id = $row090909099['id'];
  $text = $row090909099['text'];
?>
 <!-- Modal -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Point Menimbang</h5>
      ...
      <div class="modal-body">
        <input type="hidden" name="id_menimbang" value="<?php echo $id ?>"/>
        <input type="hidden" name="aksi" value="update">
       
                     <div class="form-group">
                     <textarea class="form-control" name="menimbang" style="text-align: left;"> <?php echo $text; ?></textarea>
                    </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="btn_ubah" class="btn btn-primary">Save changes</button>
      </div>
    </form>
    </div>
  </div>
...
<?php } ?>
<?php
 $query090909099=mysqli_query($conn, "SELECT id, text FROM point1 ORDER BY listorder ASC");
 while($row090909099 = mysqli_fetch_array($query090909099, MYSQL_ASSOC)){
  $id = $row090909099['id'];
  $text = $row090909099['text'];
?>
 <!-- Modal -->
<div class="modal fade" id="exampleModal2<?php echo $id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Point mengingat</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="" method="POST">
      <div class="modal-body">
        <input type="hidden" name="id_mengingat" value="<?php echo $id ?>"/>
        <input type="hidden" name="aksi" value="update">
       
                     <div class="form-group">
                     <textarea class="form-control" name="mengingat" style="text-align: left;"> <?php echo $text; ?></textarea>
                    </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="btn_ubah2" class="btn btn-primary">Save changes</button>
      </div>
    </form>
    </div>
  </div>
...
<?php } ?>
  ...
  <?php
 $query090909099=mysqli_query($conn, "SELECT id, text FROM keputusan ORDER BY listorder ASC");
 while($row090909099 = mysqli_fetch_array($query090909099, MYSQL_ASSOC)){
  $id = $row090909099['id'];
  $text = $row090909099['text'];
?>
 <!-- Modal -->
<div class="modal fade" id="exampleModal3<?php echo $id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update Point Menimbang</h5>
      ...
      <form action="" method="POST">
      <div class="modal-body">
        <input type="hidden" name="id_keputusan" value="<?php echo $id ?>"/>
        <input type="hidden" name="aksi" value="update">
       
                     <div class="form-group">
                     <textarea class="form-control" name="keputusan" style="text-align: left;"> <?php echo $text; ?></textarea>
                    </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="btn_ubah3" class="btn btn-primary">Save changes</button>
      </div>
    </form>
    </div>
  </div>
...
//hide and show 
// $('input[name=menimbang]').keyup(function(){
// if($(this).val().length)
// $('#yeah').show();
//     else
//     $('#yeah').hide();
...
$('#yeah').hide();
$('#btn').hide();
$('textarea[name=menimbang]').keyup(function(){
  if($.trim($(this).val()).length  <= 0)$('#yeah').hide()
  else $('#yeah').show()
//btuuon
